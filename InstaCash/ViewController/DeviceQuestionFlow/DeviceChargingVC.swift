...
class DeviceChargingVC: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {

    @IBOutlet weak var collectionViewCharging: UICollectionView!
    @IBOutlet weak var lblQuestionName: UILabel!
    var strNavTitleGetDeviceCharging = ""
    var arrConditionDeviceCharging = NSMutableArray()
    var arrConditionValueDataDeviceCharging = NSMutableArray()
    override func viewDidLoad() {
        super.viewDidLoad()
        setNavigationBar()
        collectionViewCharging.register(UINib(nibName: "QuestionCardTypeCell", bundle: nil), forCellWithReuseIdentifier: "questionCardTypeCell")
        let dict = arrConditionDeviceCharging[5] as? NSDictionary
        ...
        for obj in 0..<arrConditions.count{
            ...
            arrConditionValueDataDeviceCharging.insert(dict!, at: obj)
        }
    ...
    func setNavigationBar() -> Void
    {
        ...
        self.title = strNavTitleGetDeviceCharging
        ...
        btnBack.addTarget(self, action: #selector(DeviceChargingVC.btnBackPressed), for: .touchUpInside)
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return arrConditionValueDataDeviceCharging.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let dict = arrConditionValueDataDeviceCharging[indexPath.row] as? NSDictionary
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vc = DeviceBatteryVC()
        vc.strNavTitleGetDeviceBattery = self.title!
        vc.arrConditionDeviceBattery = arrConditionDeviceCharging
