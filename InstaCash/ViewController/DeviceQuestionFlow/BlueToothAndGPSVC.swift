...
class BlueToothAndGPSVC: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {

    @IBOutlet weak var collectionViewBlueTooth: UICollectionView!
    @IBOutlet weak var lblQuestionName: UILabel!
    var strNavTitleGetBlueTooth = ""
    var arrConditionBlueTooth = NSMutableArray()
    var arrConditionValueDataBlueTooth = NSMutableArray()
    override func viewDidLoad() {
        super.viewDidLoad()
        setNavigationBar()
        collectionViewBlueTooth.register(UINib(nibName: "QuestionCardTypeCell", bundle: nil), forCellWithReuseIdentifier: "questionCardTypeCell")
        let dict = arrConditionBlueTooth[4] as? NSDictionary
        ...
        for obj in 0..<arrConditions.count{
            ...
            arrConditionValueDataBlueTooth.insert(dict!, at: obj)
        }
    ...
    func setNavigationBar() -> Void
    {
        ...
        self.title = strNavTitleGetBlueTooth
        ...
        btnBack.addTarget(self, action: #selector(BlueToothAndGPSVC.btnBackPressed), for: .touchUpInside)
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return arrConditionValueDataBlueTooth.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let dict = arrConditionValueDataBlueTooth[indexPath.row] as? NSDictionary
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vc = DeviceChargingVC()
        vc.strNavTitleGetDeviceCharging = self.title!
        vc.arrConditionDeviceCharging = arrConditionBlueTooth
