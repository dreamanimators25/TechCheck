...
class BothCameraVC: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{

    @IBOutlet weak var collectionViewBothDEvice: UICollectionView!
    @IBOutlet weak var lblQuestionName: UILabel!
    var strNavTitleBothCamera = ""
    var arrConditionBothCamera = NSMutableArray()
    var arrConditionBothCameraValueData = NSMutableArray()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        setNavigationBar()
        collectionViewBothDEvice.register(UINib(nibName: "QuestionCardTypeCell", bundle: nil), forCellWithReuseIdentifier: "questionCardTypeCell")
        let dict = arrConditionBothCamera[1] as? NSDictionary
        ...
        for obj in 0..<arrConditions.count{
            ...
            arrConditionBothCameraValueData.insert(dict!, at: obj)
        }
    ...
    func setNavigationBar() -> Void
    {
        ...
        self.title = strNavTitleBothCamera
        ...
        btnBack.addTarget(self, action: #selector(BothCameraVC.btnBackPressed), for: .touchUpInside)
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return arrConditionBothCameraValueData.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let dict = arrConditionBothCameraValueData[indexPath.row] as? NSDictionary
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vc = VolumeButtonVC()
        vc.strNavTitleGet = self.title!
        vc.arrConditionVolume = arrConditionBothCamera
