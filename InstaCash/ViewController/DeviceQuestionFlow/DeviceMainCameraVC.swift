...
class DeviceMainCameraVC: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {

    @IBOutlet weak var collectionViewCamera: UICollectionView!
    @IBOutlet weak var lblQuestionName: UILabel!
    var strNavTitleGetCamera  = ""
    var arrConditionGetCamera = NSMutableArray()
    var arrConditionValueDataCamera  = NSMutableArray()
    override func viewDidLoad() {
        super.viewDidLoad()
        setNavigationBar()
        collectionViewCamera.register(UINib(nibName: "DisplayAndTouchScreenCell", bundle: nil), forCellWithReuseIdentifier: "displayAndTouchScreenCell")
        let dict = arrConditionGetCamera[7] as? NSDictionary
        ...
        for obj in 0..<arrConditions.count{
            ...
            arrConditionValueDataCamera.insert(dict!, at: obj)
        }
        ...
        collectionViewCamera.reloadData()
    ...
    func setNavigationBar() -> Void
    {
        ...
        self.title = strNavTitleGetCamera
        ...
        btnBack.addTarget(self, action: #selector(DeviceMainCameraVC.btnBackPressed), for: .touchUpInside)
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return arrConditionValueDataCamera.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let dict = arrConditionValueDataCamera[indexPath.row] as? NSDictionary
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        userDefaults.set(strNavTitleGetCamera, forKey: "productName")
