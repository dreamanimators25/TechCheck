...
class HomeButtonVC: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {

    @IBOutlet weak var collectionViewHomeButton: UICollectionView!
    @IBOutlet weak var lblQuestionName: UILabel!
    var strNavTitleGetHomeButton = ""
    var arrConditionHomeButton = NSMutableArray()
    var arrConditionValueDataHomeButton = NSMutableArray()
    override func viewDidLoad() {
        super.viewDidLoad()
        setNavigationBar()
        collectionViewHomeButton.register(UINib(nibName: "QuestionCardTypeCell", bundle: nil), forCellWithReuseIdentifier: "questionCardTypeCell")
        let dict = arrConditionHomeButton[3] as? NSDictionary
        ...
        for obj in 0..<arrConditions.count{
            ...
            arrConditionValueDataHomeButton.insert(dict!, at: obj)
        }
    ...
    func setNavigationBar() -> Void
    {
        ...
        self.title = strNavTitleGetHomeButton
        ...
        btnBack.addTarget(self, action: #selector(HomeButtonVC.btnBackPressed), for: .touchUpInside)
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return arrConditionValueDataHomeButton.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let dict = arrConditionValueDataHomeButton[indexPath.row] as? NSDictionary
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vc = BlueToothAndGPSVC()
        vc.strNavTitleGetBlueTooth = self.title!
        vc.arrConditionBlueTooth = arrConditionHomeButton
