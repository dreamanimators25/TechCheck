//
//  FifthDiagnosisQuestionVC.swift
//  InstaCash
//
...
import UIKit
import SwiftyJSON
class FifthDiagnosisQuestionVC: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    @IBOutlet weak var lblQuestionName: UILabel!
    @IBOutlet weak var collectionviewFifth: UICollectionView!
    var resultJSON = JSON()

    var arrConditionValueDataBody = NSMutableArray()
    var arrShowQuestionFifth = [NSDictionary]()
    override func viewDidLoad() {
        super.viewDidLoad()
        setNavigationBar()
        collectionviewFifth.register(UINib(nibName: "DisplayAndTouchScreenCell", bundle: nil), forCellWithReuseIdentifier: "displayAndTouchScreenCell")
        let dict = arrShowQuestionFifth[4]
        ...
        collectionviewFifth.reloadData()
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let dict = arrConditionValueDataBody[indexPath.row] as? NSDictionary
            ...
            let vc = SixthDiagnosisQuestionVC()
        vc.resultJSON = self.resultJSON
            vc.arrShowQuestionSixth = arrShowQuestionFifth
